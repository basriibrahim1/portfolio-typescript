        ...
        <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
            <Layout className="pt-0">
                <div className="flex items-center justify-between w-full 2xl:space-x-5 lg:flex-col">
                    ...
                    <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center md:mt-3">
                        <AnimatedText text="Fullstack Website & Mobile Developer" className="!text-7xl xl:!text-5xl xl:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl"/>
                        <p className="text-base font-medium my-4 md:text-sm sm:text-xs font-"><i>“Make it work, make it right, make it fast.” – Kent Beck</i></p>
